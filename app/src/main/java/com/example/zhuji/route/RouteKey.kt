package com.example.zhuji.route
...
import com.example.zhuji.utils.toJson
...
sealed class BottomTabBarRoute(
    ...
    object Home: BottomTabBarRoute(RouteKey.HOME, R.string.bottom_bar_home, R.drawable.icon_home_off, R.drawable.icon_home_on)
    object Project: BottomTabBarRoute(RouteKey.COMMUNITY, R.string.bottom_bar_community, R.drawable.icon_community_off, R.drawable.icon_community_on)
    object Navi: BottomTabBarRoute(RouteKey.JOURNEY, R.string.bottom_bar_journey, R.drawable.icon_journey_off, R.drawable.icon_journey_on)
